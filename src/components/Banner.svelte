<script>
	import WorkplaceImage from '$lib/assets/workplace.png';
</script>

<div
	class="relative text-base bg-center bg-no-repeat bg-cover h-[90vh]"
	style="background-image: url({WorkplaceImage});"
>
	...
	>
		...
		<a
			href="/contact"
			class="px-6 py-3 font-bold tracking-tight bg-accent text-primary hover:bg-base"
		>
